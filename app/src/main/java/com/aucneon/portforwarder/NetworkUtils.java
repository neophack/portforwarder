...
public class NetworkUtils {
     ...
     * 获取设备的所有本地IP地址（除回环地址）
     */
    public static List<String> getAllDeviceIpAddresses() {
     ...
     * 获取设备的所有本地IP地址的字符串表示
     */
    public static String getAllDeviceIpAddressesString() {
     ...
     */
    public static String getAllIpAddressesString(Context context) {
        List<String> ipList = new ArrayList<>();
        String wifiIp = null;
        ...
        if (ipList.isEmpty()) {
            return context.getString(R.string.no_ip_found);
        }
